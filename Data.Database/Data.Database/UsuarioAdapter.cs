    ...
    public class UsuarioAdapter:Adapter
    {
        ...
        public void Update(Usuario usuario)
        {
            try 
            {
                ...
                SqlCommand cmdSave = new SqlCommand("UPDATE usuarios SET nombre_usuario=@nombre_usuario, clave=@clave, habilitado=@habilitado, nombre=@nombre, apellido=@apellido, email=@email,id_persona=@idpersona  WHERE id_usuario=@id", sqlConn);
        ...
        protected void Insert(Usuario usuario)
        {
            try
            {
                ...
                SqlCommand cmdSave = new SqlCommand("INSERT into usuarios (nombre_usuario,clave,habilitado,nombre,apellido,email,id_persona) VALUES(@nombre_usuario, @clave, @habilitado, @nombre, @apellido, @email, @idpersona) Select @@identity", sqlConn);
