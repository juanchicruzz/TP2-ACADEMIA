    ...
    public class CursoAdapter : Adapter
    {
        ...
        public void Update(Curso c)
        {
            try
            {
                ...
                SqlCommand cmdSave = new SqlCommand("UPDATE cursos set id_materia=@id_materia,desc_curso=@desc,id_comision=@id_comision, anio_calendario=@anio,cupo=@cupo where id_curso=@id", sqlConn);
